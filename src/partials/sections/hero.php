      ...
      <div class="row align-items-center gy-8">
        <div class="col-lg-6">
          ...
          <h1 class="display-4 fw-bold  mt-4">
            Membangun
            <span class="text-primary">Inovasi & Efisiensi,</span>
            Masa Depan
          </h1>

          <p class="my-6 lead fw-normal">
            Bergabunglah dengan Program Studi Teknik Industri. Kami mencetak sarjana teknik yang andal dalam
            perancangan, perbaikan, dan instalasi sistem terintegrasi.
          </p>
          <div class="d-flex flex-md-row flex-column justify-content-start   gap-3">
            <a href="https://pmb-mip.politeknikmeta.ac.id/" class="btn btn-primary">
            ...
            <a href="https://www.youtube.com/@humaspoliteknikmetaindustr8587" class="btn btn-light">
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
          ...
          <div class="d-flex gap-6 mt-8">
            ...
            <div class="d-flex align-items-center gap-2">
              ...
              <small class="mb-0"><span class="fw-bold">Akreditasi </span> B</small>
            </div>
            <div class="d-flex align-items-center gap-2">
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              ...
              <small class="mb-0"><span class="fw-bold">42+</span> Mitra Industri</small>
            </div>
        ...
        <div class="col-lg-6">
          <div class="card p-3 rounded-5  shadow-sm">
            <div class="position-relative">
              <div class="position-relative">
                <img src="./assets/images/hero-img.jpg" alt="about" class="rounded-5 img-fluid" />

                <a href="https://www.youtube.com/watch?v=SEBV0KFypEw&t=1s"
                  class="play-btn glightbox position-absolute top-50 start-50 translate-middle icon-shape icon-xl rounded-circle text-white">
                ...
                <!-- <div class="position-absolute top-0 end-0  me-n8 mt-n4">
                  <div class="bg-white shadow-sm rounded-pill d-flex align-items-center gap-3 px-3 py-2  mb-4 border"
                    ...
                    <!-- <div class="avatar-group">
                      ...
                      <img src="./assets/images/avatar/avatar-3.jpg" alt="" class="avatar avatar-sm rounded-circle">
                    </div>
